    ...
    private void applyChangeClassNameActionPatchAndCheckResult(String cacheName, boolean checkQueryEntities) {
        ...
        context.patchCachesWhichEndWith(cacheName, cachePath -> {
            ...
            action = new ChangeClassNameAction.Builder()
                    .action(action)
                    .changeClassName("io.github.alliedium.ignite.migration.test.model.City",
                            "io.github.alliedium.ignite.migration.changed.test.model.City")
                    .build();
        ...
        if (checkQueryEntities) {
            ...
            Assert.assertEquals(queryEntity.getValueType(), "io.github.alliedium.ignite.migration.changed.test.model.City");
        }
        ...
        Assert.assertEquals(typeName, "io.github.alliedium.ignite.migration.changed.test.model.City");
    }
}
